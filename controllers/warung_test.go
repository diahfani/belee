...
func TestUpdateWarungFailedEmptyParam(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "http://localhost:8000/api/v1/warungs/", requestBody)
...
func TestDeleteWarungFailedEmptyParam(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodDelete, "http://localhost:8000/api/v1/warungs/", requestBody)
