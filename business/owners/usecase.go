...
func (uc *OwnerUsecase) Login(ctx context.Context, buyerDomain Domain) (Domain, string, error) {
...
func (uc *OwnerUsecase) Register(ctx context.Context, data Domain) (Domain, string, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.contextTimeout)
	defer cancel()
